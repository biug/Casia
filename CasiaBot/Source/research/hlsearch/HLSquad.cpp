...
_strengthCalculated(false)
{
	...
	CAB_ASSERT(_currentRegion != NULL, "Current region is null!");
}
...
std::list<BWTA::Region*> CasiaBot::getPath(BWTA::Region *from, BWTA::Region *to)
{
	//Logger::LogAppendToFile(CAB_LOGFILE, "Performing A*");
...
std::unordered_set<BWTA::Region*> CasiaBot::getNeighbours(const BWTA::Region *region)
{
