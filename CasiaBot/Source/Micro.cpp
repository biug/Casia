...
{
    CAB_ASSERT(attacker, "SmartAttackUnit: Attacker not valid");
    CAB_ASSERT(target, "SmartAttackUnit: Target not valid");
...
{
    //CAB_ASSERT(attacker, "SmartAttackMove: Attacker not valid");
    //CAB_ASSERT(targetPosition.isValid(), "SmartAttackMove: targetPosition not valid");
...
{
    CAB_ASSERT(rangedUnit, "SmartKiteTarget: Unit not valid");
    CAB_ASSERT(target, "SmartKiteTarget: Target not valid");
...
{
    CAB_ASSERT(muta, "MutaDanceTarget: Muta not valid");
    CAB_ASSERT(target, "MutaDanceTarget: Target not valid");
